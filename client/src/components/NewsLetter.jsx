...
const NewsLetter = () => {
  return (
    ...
    <div className="flex flex-col items-center
     max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gradient from-blue-50 via-indigo-50 to-purple-50 border border-gray-100 shadow-lg">
