...
const AllRooms = () => {
    ...
    const matchesRoomType=(room)=>{
        return selectedFilters.roomType.length === 0 || setSelectedFilters.roomType.includes(room.roomType)
    }
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-24 xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                <h1 className='font-playfair text-4xl md:text-[40px]'>Hotel Rooms
                </h1>
                <p className='text-sm md:base text-gray-500/90 mt-2 max-w-174'> Take advantage of our limited-time offers and special package to enhance your stay and create unforgettable memories.</p>
            ...
            {filteredRooms.map((room)=>(
                ...
                py-10 gap-6 border-b border-gray-300 last:pb-30 last-border-0'>
                    ...
                    title='View Room Details' className='max-h-65
                     md:w-1/2 rounded-xl shadow-lg object-cover 
                    cursor-pointer' />
                    ...
                    scrollTo(0,0)}}
                     className='text-gray-800 text-3xl font-playfair cursor-pointer'>
                        ...
                        <div className='flex flex-rap items-center mt-3 mb-6 gap-4'>
        ...
        <div className='bg-hite w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16 '>
                ...
                <div className='px-5 pt-5 pb-7'>
                    ...
                    </p>
                    {
                        sortOptions.map((option, index)=>(
                            ...
                            selected={setSelectedSort === option} 
